...
@Service
public class FPTree {
    private long absSupport = 0;

    public void FpTreeInit(String filePath, long absSupport) {
        this.absSupport = absSupport;

        List<String[]> matrix = Reader.readAsMatrix(filePath, "\t ", "utf-8");
    ...
    private Holder getConditionFpTree(Map<List<String>, Long> paths) {
        ...
        return new FPTree().new Holder(cRoot, cHeader);
    }
